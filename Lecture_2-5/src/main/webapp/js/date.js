...
function demo1() {
    // 5. oktober som antall millisekund siden 1. januar 1970
    const ms = Date(2023, 9, 5); // Statisk Date metode;
    console.log(ms);
}

function demo2() {
    //  6. oktober 2023 som Date objekt
    const dato = new Date(2023, 9, 6);
    console.log(dato);
}
